...
type MultiSearchCollectionParameters struct {
	...
	// VectorQuery The vector query to search for documents that contain a vec field value closest to a given query vector.
...
type SearchResultHit struct {
	...
	// Highlight Contains highlight portions of the search fields
	Highlight *map[string]map[string]interface{} `json:"highlight,omitempty"`
